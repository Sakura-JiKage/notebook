...
>
>- **方言属性**：
>  - 在关西地区（大阪、京都、神户等），判断句不用「だ」而用「や」。
>    - 例：
>      标准语「今日は普通**だ**」 → 关西弁「今日は普通**や**」
>      标准语「そう**だ**」 → 关西弁「そう**や**」
>- **语气差异**：
>  - 「や」比「だ」更随意亲切，但对外地人可能显得粗鲁（需注意场合）。
>
>#### **(2) 「な」的语感**
>
>- 此处表**自言自语**或**寻求认同**：
...
>如果听到「今日は普通やな」，可以回应：
>
>- **「そうやな～。明日はもっと楽しいことしよう！」** （是啊～明天找点乐子吧！）
>- **「普通が一番ええねん」** （平凡最可贵～关西式哲理）
>
>
...
>&emsp;&emsp;<strong><big>迫る</big></strong>（せまる）：(ています形)迫っています。
>
